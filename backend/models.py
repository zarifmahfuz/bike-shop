...
class BikeSale(models.Model):
    ...
    net_sale = models.DecimalField("sale value - discount applied", max_digits=8, decimal_places=2)
    refund = models.DecimalField(max_digits=8, decimal_places=2, default=0, blank=True)
